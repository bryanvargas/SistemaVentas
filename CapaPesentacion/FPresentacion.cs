...
namespace CapaPesentacion
{
    public partial class FPresentacion : Form
    {
        ...
        {
            InitializeComponent();
            this.mensaje_tt.SetToolTip(this.nombre_txt, "Ingrese el nombre de la Presentacion");
        }
        ...
        {
            this.listado_data.DataSource = NPresentacion.Mostrar();
        ...
        {
            this.listado_data.DataSource = NPresentacion.BuscarNombre(this.buscar_txt.Text);
            this.OcultarColumnas();
            total_lbl.Text = "Total de Registros: " + Convert.ToString(listado_data.Rows.Count);
        }

        //este metodo se carga siempre que se inicialize la aplicacion ojo con eso-....
            ...
            try
            {
                ...
                else
                {
                    if (this.is_nuevo)
                    {
                        ...
                        salida = NPresentacion.Insertar(this.nombre_txt.Text.Trim(), descripcion_txt.Text.Trim());
                    }
                    else
                    {
                        salida = NPresentacion.Editar(Convert.ToInt32(this.codigo_txt.Text), nombre_txt.Text.Trim(), descripcion_txt.Text.Trim());
                    }
                    if (salida.Equals("OK"))
                    {
                        if (this.is_nuevo)
                ...
                if (opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in listado_data.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            salida = NPresentacion.Eliminar(Convert.ToInt32(codigo));
        ...
        {
            this.codigo_txt.Text = Convert.ToString(this.listado_data.CurrentRow.Cells["idpresentacion"].Value);
